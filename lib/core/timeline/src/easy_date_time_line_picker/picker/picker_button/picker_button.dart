...
class _PickerButtonState extends State<PickerButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = colorScheme.onSurface.withAlpha(60);
    final double effectiveHorizontalPadding = math.max(0, widget.timelinePadding.horizontal - _innerPadding);
    return Padding(
            ...
            child: Center(
              child: Row(
                children: [
                  Flexible(
                    child: Text(
                      DateFormat(DateFormatUtils.dMonthY, widget.local).format(widget.date),
