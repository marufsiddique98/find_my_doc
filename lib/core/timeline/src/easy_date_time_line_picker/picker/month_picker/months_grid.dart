...
class MonthsGrid extends StatelessWidget {
  ...
  bool _isMonthSelected(DateTime date) {
    return focusedDate != null && date.month == focusedDate!.month && date.year == focusedDate!.year;
  }
...
class _MonthPickerGridDelegate extends SliverGridDelegate {
  ...
  SliverGridLayout getLayout(SliverConstraints constraints) {
    final double tileWidth = (constraints.crossAxisExtent - (_monthPickerColumnCount - 1) * _monthPickerRowSpacing) / _monthPickerColumnCount;
