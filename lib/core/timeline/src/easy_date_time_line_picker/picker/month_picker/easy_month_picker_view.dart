...
class _EasyMonthPickerViewState extends State<EasyMonthPickerView> {
  ...
  bool get _isDisplayingFirstYear => widget.focusedDate.year == widget.firstDate.year;

  /// Returns true if the currently displayed year is the last available year.
  bool get _isDisplayingLastYear => widget.focusedDate.year == widget.lastDate.year;
  ...
  Widget build(BuildContext context) {
    final Color controlColor = Theme.of(context).colorScheme.onSurface.withAlpha(60);
    return Semantics(
      child: Column(
        children: [
          SizedBox(
