...
class _DayWidgetState extends State<DayWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dayMiddlePartStyle = resolve<TextStyle?>((theme) => widget.isToday ? theme?.currentDayMiddleElementStyle : theme?.dayMiddleElementStyle, states);
    final TextStyle? dayTopPartStyle = resolve<TextStyle?>((theme) => widget.isToday ? theme?.currentDayTopElementStyle : theme?.dayTopElementStyle, states);
    final TextStyle? dayBottomPartStyle = resolve<TextStyle?>((theme) => widget.isToday ? theme?.currentDayBottomElementStyle : theme?.dayBottomElementStyle, states);

    // Resolve colors based on the current state and theme
    final Color? dayForegroundColor = resolve<Color?>((theme) => widget.isToday ? theme?.currentDayForegroundColor : theme?.dayForegroundColor, states);
