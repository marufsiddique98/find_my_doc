...
class EasyDayWidget extends StatelessWidget {
  ...
  BoxDecoration _buildDayDefaultDecoration(Color backgroundColor) {
    ...
    final todayHighlightColor = easyDayProps.todayHighlightColor ?? (isBackgroundHighlight ? backgroundColor.withAlpha(20) : backgroundColor);
  ...
  DayInfoText _buildMonth(bool isToday) {
    ...
    final inactiveMothStrStyle = _inactiveDayStyle.monthStrStyle ?? easyDayProps.inactiveMothStrStyle ?? EasyTextStyles.monthStrStyle;
