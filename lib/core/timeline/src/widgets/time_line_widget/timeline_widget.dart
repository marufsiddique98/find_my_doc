...
class _TimeLineWidgetState extends State<TimeLineWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveTimeLineBackgroundColor = _timeLineProps.decoration == null ? _timeLineProps.backgroundColor : null;
    final effectiveTimeLineBorderRadius = _timeLineProps.decoration?.borderRadius ?? BorderRadius.zero;
        ...
        child: ScrollConfiguration(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final isSelected = EasyDateUtils.isSameDay(widget.focusedDate ?? initialDate, currentDate);
